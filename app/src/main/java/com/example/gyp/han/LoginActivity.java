...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mWebview = (Button) findViewById(R.id.webview1);
        ...
        edit_id = (EditText) findViewById(R.id.email);//edit_id변수와 xml에 id입력 부분을 연결
        edit_pw = (EditText) findViewById(R.id.password);//edit_pw변수와 xml에 pw입력 부분을 연결
...
/*  통신 구현중
    ...
    private String SendByHttp(String msg) {
        ...
        String URL = "http://14.63.222.55:8080/test4/main.jsp"; //자신의 웹서버 주소를 저장
